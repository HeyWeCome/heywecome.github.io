...
const DOMAIN_NAME = 'heywecome.github.io/' // 域名 (不带https)
...
export default defineConfig4CustomTheme<VdoingThemeConfig>({
  ...
  themeConfig: {
    ...
    author: {
      name: 'HeyWeCome', // 必需
      link: 'https://github.com/HeyWeCome', // 可选的
    },

    // 博主信息 (显示在首页侧边栏)
    blogger: {
      avatar: 'https://avatars.githubusercontent.com/u/30435835?v=4',
      name: 'HeyWeCome',
      slogan: '初学者',
    },
      ...
      icons: [
        {
          ...
          title: '发邮件',
          link: 'mailto:heywecome@gmail.com',
        },
        {
    ...
    footer: {
      ...
      copyrightInfo:
        'HeyWeCome | MIT License</a>', // 博客版权信息、备案信息等，支持a标签或换行标签</br>
    },
